...
console.log("Neutrino routing - production");
...
angular.module("neutrinoProject").config(['$routeProvider', '$locationProvider', 'applicationConfigurationProvider',
    ...
    {
        templateUrl: function (rp) { return baseSiteUrlPath + 'views/' + rp.rootSection + '/' + rp.section + '/' + rp.tree + '.html?v=' + this.getApplicationVersion(); },

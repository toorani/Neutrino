...
namespace Neutrino.Interfaces
{
        ...
        
    {
        ...
        Task<IBusinessResultValue<List<ReportBranchPromotionDetail>>> LoadReportBranchPromotionDetail(DateTime startDate, DateTime endDate, params GoalGoodsCategoryTypeEnum[] goalGoodsCategoryTypeIds);
